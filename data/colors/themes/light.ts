...
const scale = {
  ...
  blue: ['#ECEFF8', '#D8DFF1', '#B2BFE2', '#8BA0D4', '#6580C5', '#3E60B7', '#3856A5', '#324D92', '#5F7BC0', '#1F305C'],
  green: ['#EAF1EF', '#C1D5CF', '#ACC7BF', '#83ACA0', '#599080', '#307460', '#2B6856', '#265D4D', '#225143', '#183A30'],
  yellow: [
    '#FFFBEB',
    '#FFF6D6',
    '#FFEDAD',
  ...
  red: ['#FAE7E9', '#F5CFD4', '#EBA0A8', '#E2707D', '#D84151', '#CE1126', '#B90F22', '#A50E1E', '#900C1B', '#670913'],
  purple: [
    '#F5F0FF',
    '#E6DCFD',
    '#D1BCF9',
